...
/*
 Додати приближення в чарті
 Зробити переміщення слайдером

 Виписати, які метрики потрібні
 Виписати, які графіки потрібні для яких метрик
 Створити структуру з вибором графіків по MetricIdentifier
 
 Відредагувати лінеар чарт
 
 Додати розширення до масиву Сетів (сер вага і повтори)
 
 Додати методи в менеджері метрик для апдейту, сумування, видалення
 
 Створити інші графіки
